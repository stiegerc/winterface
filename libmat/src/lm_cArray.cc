...
// printing
template<>
std::string lm_tArray<CPX__,RE__,CPX__>::print(const size_t precision, const size_t blanks) const noexcept {
...
template lm_tMat<CPX__,RE__,CPX__> operator+<CPX__,RE__,CPX__>(const RE__ lhs, const lm_tArray<CPX__,RE__,CPX__>& rhs) noexcept;
template lm_tMat<CPX__,RE__,CPX__> operator+<CPX__,RE__,CPX__>(const CPX__& lhs, const lm_tArray<CPX__,RE__,CPX__>& rhs) noexcept;
template lm_tMat<CPX__,RE__,CPX__> operator-<CPX__,RE__,CPX__>(const RE__ lhs, const lm_tArray<CPX__,RE__,CPX__>& rhs) noexcept;
template lm_tMat<CPX__,RE__,CPX__> operator-<CPX__,RE__,CPX__>(const CPX__& lhs, const lm_tArray<CPX__,RE__,CPX__>& rhs) noexcept;
template lm_tMat<CPX__,RE__,CPX__> operator*<CPX__,RE__,CPX__>(const RE__ lhs, const lm_tArray<CPX__,RE__,CPX__>& rhs) noexcept;
template lm_tMat<CPX__,RE__,CPX__> operator*<CPX__,RE__,CPX__>(const CPX__& lhs, const lm_tArray<CPX__,RE__,CPX__>& rhs) noexcept;
