...
template<>
void test_r_tVecItr_all<RE__,RE__,CPX__,lm_tRow<RE__,RE__,CPX__>>::test_dereference() {
...
// test id
template<>
const char* test_r_tVecItr_all<RE__,RE__,CPX__,lm_tRow<RE__,RE__,CPX__>>::test_id() noexcept {
	return "test_r_fRowItr_all";
}

// instantiation
template class test_r_tVecItr_all<RE__,RE__,CPX__,lm_tRow<RE__,RE__,CPX__>>;
