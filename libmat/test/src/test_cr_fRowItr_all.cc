...
template<>
void test_cr_tVecItr_all<RE__,RE__,CPX__,lm_tRow<RE__,RE__,CPX__>>::test_dereference() {
...
// test id
template<>
const char* test_cr_tVecItr_all<RE__,RE__,CPX__,lm_tRow<RE__,RE__,CPX__>>::test_id() noexcept {
	return "test_cr_fRowItr_all";
}

// instantiation
template class test_cr_tVecItr_all<RE__,RE__,CPX__,lm_tRow<RE__,RE__,CPX__>>;
