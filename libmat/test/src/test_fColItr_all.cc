...
template<>
void test_tVecItr_all<RE__,RE__,CPX__,lm_tCol<RE__,RE__,CPX__>>::test_dereference() {
...
// test id
template<>
const char* test_tVecItr_all<RE__,RE__,CPX__,lm_tCol<RE__,RE__,CPX__>>::test_id() noexcept {
